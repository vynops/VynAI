      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-slate-400 mt-0.5">
            OpenAI-compatible endpoint · <code className="font-mono text-cyan-400">http://localhost:3005/v1</code>
          </p>
        </div>
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="rounded-lg bg-slate-950 border border-slate-800 p-3 font-mono text-xs text-slate-300 overflow-x-auto">
              ...
              <div>client = OpenAI(base_url=<span className="text-cyan-400">&quot;http://localhost:3005/v1&quot;</span>, api_key=<span className="text-green-400">&quot;sk-vynai-...&quot;</span>)</div>
            </div>
          </div>
        </div>
      </div>
